<template>
  <div class="container">
        ...
        <div id="demo" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./img/diente.jpg" alt="Silla"  />
            </div>
            <div class="carousel-item">
              <img src="./img/diente2.jpg" alt="pared" />
            </div>
            <div class="carousel-item">
              <img src="./img/diente3.jpg" alt="maquina" />
            </div>
          </div>
    ...
    >
      ...
      <div class="form-group">
        <label for="inputAddress2">Deja una breve descripción:</label>
        <input
          autocomplete="nofill"
          type="text"
      ...
      <div class="form-group">
        <label for="textarea">Deja un mensaje para el receptor:</label>
    ...
    <div class="container">
      <div class="row text-center">
        <div class="w-100 text-center">
          ...
          <h5 class="mb-3 text-center" v-show="showpaypal === true">Por favor, ingrese 50€ para conseguir su bono</h5>
        </div>
